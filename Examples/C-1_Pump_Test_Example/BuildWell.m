...
elseif format=='B'
                [Column1,Column2,Column3,Column4,Column5,Column6,Column7,Column8,Column9,Column10,Column11,Column12,Column13,Column14,Column15,Column16,Column17,Column18,Column19,Column20,Column21,Column22,Column23,Column24,Column25,Column26,Column27,Column28,Column29,Column30,Column31,Column32,Column33,Column34,Column35,Column36,Column37] = importfile(filename, startrow, endrow, format);
                atime=Column1; % time column
                adata_1=Column30; % Water Evelation column of first port
                adata_2=Column32; % Water Evelation column of second port
                adata_3=Column33; % Water Evelation column of third port
                adata_4=Column35; % Water Evelation column of fourth port
                adata_5=Column36; % Water Evelation column of fifth port
                adata_6=Column37; % Water Evelation column of sixth port
...
%                 Well.yi{8}=yi{8};
                ...
                Well.noise{3}=[datenum(noisestart_3_1)  datenum(noiseend_3_1)                               %%
                                datenum(noisestart_3_2)  datenum(noiseend_3_2)                              %%                             
                                datenum(noisestart_3_3)  datenum(noiseend_3_3)                              %%
                                datenum(noisestart_3_4)  datenum(noiseend_3_4)                              %%
                                datenum(noisestart_3_5)  datenum(noiseend_3_5)];                            %%
                Well.noise{4}=[datenum(noisestart_4_1)  datenum(noiseend_4_1)                               %%
                               datenum(noisestart_4_2)  datenum(noiseend_4_2)];                             %%
                Well.noise{5}=[datenum(noisestart_5)  datenum(noiseend_5)];                                 
                Well.noise{6}=[datenum(noisestart_6_1)  datenum(noiseend_6_1)                               %%                              
                                datenum(noisestart_6_2)  datenum(noiseend_6_2)                              %%
                                datenum(noisestart_6_3)  datenum(noiseend_6_3)];                            %%
