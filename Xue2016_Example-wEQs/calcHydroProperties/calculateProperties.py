...
if __name__== "__main__":
    ...
    for well in wellList:
        ...
        if 'vert' in flowModel:
            z = wellInfo[well]['z']  #probably only need depth for vert flow
    ...
    #---------------------------------------------
    # PLOT PERMEABILITY AND S_S FOR ALL WELLS ON SINGLE PLOT (Xue2016 Fig 6)
    #---------------------------------------------
    fig, (ax1,ax2) = plt.subplots(2, figsize=(10, 6))
    for well in wellList:
    ...
    ax2.set_xlabel('Date')
    ax1.set_xlim(right=datetime(2015,12,1,0,0,0))
