...
%LoadTides.m
Tide_dt=1/24/60; %[d] tidal sample spacing in units of days for the synthetic tidal model

%BuildWell.m
dt=10/24/60; %[d] time sample spacing of the well data in units of days
tidedate='2003-07-01 00:00:00'; %date of start of synthetic tide 'YYYY-MM-DD hh:mm:ss' format
...
cUTC=7/24; % correction from time of collected data to UTC (if collected in local time). Pacific time [UTC-7]
            % may require som preprocessing if Daylight Savings Time is not already corrected for.
            
%PlotOriginalWL.m
PlotTime1='2003-07-01'; % Date of beginning of plot in 'YYYY-MM-DD' format
PlotTime2='2004-07-01'; % Date of ending of plot in 'YYYY-MM-DD' format
...
%avg_amp_phase.m
PlotTime5='2003-07-01'; % Date of beginning of plot in 'YYYY-MM-DD' format
PlotTime6='2004-07-01'; % Date of ending of plot in 'YYYY-MM-DD' format
