...
%%%%%%%%%%%%%%%
% MC UNCERTAINTY PROPAGATION (OPTIONAL)
%%%%%%%%%%%%%%%
elseif MC==1;
    display('Performing MC uncertainty propagation...')
...
##    [Respon]=water_respon_time(-mc_Wcuti_f,tidecut_f',tcuti,dt,t_win,n_shift,pgap);
  ...
  display('Valid options for MC are 0 or 1. Enter a valid option in UserParam.m');
end
...
##  T0=mean([mcRespon.time],2);
  ...
  % (for stdev, calculate based on the reciprocal amp values)
  amp_M2 = [mcRespon.amp_M2]; %each col is a mc sim, each row is a time
  recip_amp_M2 = 1./amp_M2;
  A0_std=std([recip_amp_M2],opt=1,dim=2); #[1/m]

  Ph_deg_std=[Ph_deg_std Ph_deg0_std];
  A_std=[A_std A0_std];
  
  %Calculate the 95% confidence intervals 
  %https://www.mathworks.com/matlabcentral/answers/696780-calculate-confidence-interval-of-data-set
  % Calculate using Z-value: assumes normal distribution (safe assumption for these data)
##  A_ci_z = [ 1./A - 1.96*(A_std./sqrt(numel(A))), ...
##             1./A + 1.96*(A_std./sqrt(numel(A))) ];
  A_ci_z = [ 1./A - 1.96*(A_std./sqrt(N_mc)), ...
            1./A + 1.96*(A_std./sqrt(N_mc)) ];
  Ph_ci_z =[ Ph_deg - 1.96*(Ph_deg_std./sqrt(N_mc)), ...
             Ph_deg + 1.96*(Ph_deg_std./sqrt(N_mc))];
  % !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! 
  % !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! 
  % !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! 
  % !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! 
...
##
##figure;
##X = 1./[mcRespon.amp_M2](1,:);
##hist(X, nbins=20, norm=1.0);
##hold on;
##meantext = ['mean = ' num2str(1./A0(1)) ''];
